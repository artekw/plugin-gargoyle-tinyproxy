...
{
	var enable = getSelectedValue("tinyproxy_enable");
...
{
	setInvisibleIfIdMatches("tinyproxy_enable", "0", "tinyproxy_container", "block", document);
}
...
function resetData()
{
	...
	var enable = uciOriginal.get("tinyproxy", tpSections[0], "enable");
	setSelectedValue("tinyproxy_enable", enable);
